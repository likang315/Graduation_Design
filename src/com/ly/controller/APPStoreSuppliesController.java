...
public class APPStoreSuppliesController {
	...
	public String tostoreSupplies(Model model, HttpSession session) {
		...
		List<Map<String, Object>> materials = appStroreSuppliesService
				.getMaterials();// 所在所有物资
	...
	public Object appendOrRemove(String materialId, String materialName,
		...
		mList = (List<Map<String, Object>>) session
				.getAttribute("storeMaterial");
	...
	public String addmaterial(APPStoreSupplies appStoreSupplies,
		...
		if (appStroreSuppliesService.addmaterial(appStoreSupplies, session)) {
			attributes.addAttribute("info", "需求上报成功！");
		} else {
			attributes.addAttribute("info", "需求上报失败！");
		}
		attributes.addAttribute("channel_code",
				appStoreSupplies.getChannel_code());
	...
	public Object StoreAllTotal(Model model, String channel_code, String state,
		...
		List<Map<String, Object>> map = appStroreSuppliesService
				.StoreAllTotal(m);
		...
		if (info != null && info != "") {
			try {
				model.addAttribute("info",
						new String(info.getBytes("ISO-8859-1"), "UTF-8"));
			} catch (UnsupportedEncodingException e) {
				e.printStackTrace();
			}
		}
	...
	@ResponseBody
	public Object storeList(Model model, String channel_code, String state,
			String searchMsg, String startTime, String endTime, Integer jiazai) {
	...
	public String storelistDetails(Model model, String id, String channel_code) {
		...
		m.put("id", id);
		m.put("channel_code", channel_code);
		Map<String, Object> map = appStroreSuppliesService
				.findStoreListDetails(m);
