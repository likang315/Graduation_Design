...
public class ResourcesController extends BaseController {
	 ...
	 * 
	 * @ResponseBody public Map<String, Object> sortUpdate(Model model,Params
	 * params,HttpServletRequest request) throws Exception{
	 * resourcesService.updateSortOrder(params.getResources()); return
	 * resourcess(model,new Resources(),request); }
	 */
	/**
	 * 某个角色拥有的权限
	 * 
	...
	public String permissioRole(Model model, String roleId, String groupId,
		...
		return Common.BACKGROUND_PATH + "/resource/permissioUser";
	}
