...
/**
 * 快递员，快递公司后台控制
 * @author 殷瑜泰 2017年3月21日下午1:49:24
 *
 */
@Controller
...
public class BackExpressController {
	...
	/**
	 * 查询跳转到公司的清单
	 * @author 殷瑜泰 2017年3月21日下午2:57:50
	 *
	 * @param model
	 * @return
	 */
	...
	/**
	 * 跳转到新增快递公司页面
	 * @author 殷瑜泰 2017年3月21日下午3:00:34
	 *
	 * @param model
	 * @return
	 */
	...
	/**
	 * 快递员清单信息管理
	 * @author 殷瑜泰 2017年3月22日上午11:28:08
	 *
	 * @return
	...
	public String courierList(String pageNow, String info, String modifyInfo, String deleteInfo, Model model ) throws UnsupportedEncodingException{
	...
	/**
	 * 跳转到快递员信息维护页面
	 * @author 殷瑜泰 2017年3月22日下午2:35:36
	 *
	 * @param pageNow
	 * @param model
	 * @return
	...
	/**
	 * 维护快递员数据
	 * @author 殷瑜泰 2017年3月22日下午3:36:03
	 *
	 * @param storeInfo
	 * @param file
	...
	public String addCourier(@RequestParam Map courierInfo,@RequestParam(value="file", required = false) MultipartFile file,  RedirectAttributes redirectAttributes,HttpSession session){
		//维护店员信息
	...
	/**
	 * 根据id删除快递员信息
	 * @author 殷瑜泰 2017年3月24日上午9:56:57
	 *
	 * @param id
	 * @return
	 */
	...
	/**
	 *跳转到店员信息修改页面 
	 * @author 殷瑜泰 2017年3月24日上午11:09:09
	 *
	 * @return
	 */
	@RequestMapping("/permissioCourier")
	public String permissioCourier(String id, Model model){
		//根据快递员的id查询出快递员的信息
	...
	/**
	 * 修改信息
	 * @author 殷瑜泰 2017年3月24日上午11:33:34
	 *
	 * @param id
	 * @param model
	 * @return
