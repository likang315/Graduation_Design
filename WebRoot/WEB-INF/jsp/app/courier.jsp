...
<div class="container">
    ...
    <div class="courierSelectDiv">
        <form id="form" action="${pageContext.servletContext.contextPath }/app/fillingSingle/putInMaterialInfo.html"
              method="post">
...
<form action="${pageContext.request.contextPath}/app/fillingSingle/addMailInfor.html" method="post" id="myform">
    ...
    <input type="hidden" id="marketingMobiles" name="accountPhone"/><!-- 生成该次订单任务的集团人员电话 -->
</form>

<!-- 蒙版 -->
<div id="bigblack2"
     style="z-index:5554;width:100%;background:#000;height:100%;position: fixed;top:0px;left:0px;opacity:0.7;display: none;"></div>
...
<div id="yesOrNo" style="position:fixed; width:100%; top:150px; z-index: 999999; display: none;">
    <div style="width:80%; margin-left:10%; background:#FFF; padding:20px; border-radius:5px;">
        <div>确认本次派送任务吗?</div>
        <div style="text-align:right; margin-top:20px;"><a href="javascript:myConfirm();">确认</a>&nbsp;&nbsp;&nbsp;<a
                href="javascript:myClose();">关闭</a>
        </div>
    </div>
</div>
...
<script>
    ...
    $("#findPhone").keyup(function () {
        ...
        $.post("${pageContext.request.contextPath}/app/fillingSingle/getCourier.html", {
            "expressId": fallId,
            "condition": condition
        }).done(function (data) {
            var ants = "";
    ...
    function myConfirm() {
        ...
        $("#marketingMobiles").val(user.accountName);
        $("#myform").submit();
    }
