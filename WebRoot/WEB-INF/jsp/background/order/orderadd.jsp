...
<div class="formbody">
    <div id="usual1" class="usual">
        ...
        <form id="fileForm" action="${pageContext.servletContext.contextPath }/background/order/addOrder.html"
                ...
                <table border="0" cellpadding="0" cellspacing="0" bgcolor="#66CCFF" class="tablelist_left">
                    <tr>
                        ...
                        <td height="38" bgcolor="#FFFFFF">
                            <div align="left">
                                <div align="left">
                                    <input type="file" name="file" id="file" class="dfinput"/>
                                    <div id="tip"></div>
                                </div>
                            </div>
                        </td>
                    ...
                    <tr>
                        ...
                        <td height="54" bgcolor="#FFFFFF"><input type="button" class="btn-primary btn-sm" id="submit1"
                                                                 value="确认维护"/>
                            <input class="btn-primary  btn-sm"
                                   onclick="javascript:window.location.href='javascript:history.go(-1)'" id="backBt1"
                                   type="button" class="btn" value="　返　回　"/>
