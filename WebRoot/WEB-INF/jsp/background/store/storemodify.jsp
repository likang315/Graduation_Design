...
<body>
    ...
    <div class="itab_nav">
  	<ul> 
    <li><a href="#tab1" id="sigStore" class="selected">门店单个维护</a></li>
  	</ul>
    </div>
    <div class="line" >
 ...
 <div class="toolbar1"></div>
 <form id="addForm" action="${pageContext.servletContext.contextPath }/background/Stroe/modify.html" method="post" enctype="multipart/form-data">
 <table border="0" cellpadding="0" cellspacing="0" bgcolor="#66CCFF"  class="tablelist_left">
   <tr>
    <input type="hidden" name="id" id="id"  value="${storeInfo.id }"/>
     ...
     <td width="10%" height="38" align="center" bgcolor="#F0F5F7"><div>门店名称：</div></td>
     <td height="38" bgcolor="#FFFFFF"><div align="left">
       <input name="store_name" id="store_name" class="dfinput" value="${storeInfo.store_name }" onblur="check()"/>
       <label id="tipStore_name"></label>
     </div></td>
     </tr>
   <tr>
     <td width="10%" height="38" align="center" bgcolor="#F0F5F7"><div>门店地址：</div></td>
     <td height="38" bgcolor="#FFFFFF"><div align="left">
       <div align="left">
         <input name="store_address" id="store_address" class="dfinput" value="${storeInfo.store_address }" onblur="check()"/>
    ...
    <%-- <tr>
     <td width="10%" height="38" align="center" bgcolor="#F0F5F7"><div>门店经度：</div></td>
     <td height="38" bgcolor="#FFFFFF"><div align="left">
       <div align="left">
         <input name="store_longitude" id="store_longitude" class="dfinput" value="${storeInfo.store_longitude }" onblur="check()"/>
         <label id="tipStore_longitude"></label>
       </div>
     </div></td>
     </tr>
    <tr>
     <td width="10%" height="38" align="center" bgcolor="#F0F5F7"><div>门店纬度：</div></td>
     <td height="38" bgcolor="#FFFFFF"><div align="left">
       <div align="left">
         <input name="store_latitude" id="store_latitude" class="dfinput" value="${storeInfo.store_latitude }" onblur="check()"/>
         <label id="tipStore_latitude"></label>
       </div>
     </div></td>
     </tr> --%>
     <tr>
     <td width="10%" height="38" align="center" bgcolor="#F0F5F7"><div>门头照片：</div></td>
     <td height="38" bgcolor="#FFFFFF"><div align="left">
       <div align="left">
      ...
      <tr>
     <td width="10%" height="38" align="center" bgcolor="#F0F5F7"><div>门店店长电话：</div></td>
     <td height="38" bgcolor="#FFFFFF"><div align="left">
       <div align="left">
         <input name="store_shopowner_phone" id="store_shopowner_phone" class="dfinput" value="${storeInfo.store_shopowner_phone }"/>
         <label id="tipStore_shopowner_phone"></label>
       </div>
     </div></td>
     </tr>
     <tr>
     <td width="10%" height="38" align="center" bgcolor="#F0F5F7"><div>店长姓名：</div></td>
     <td height="38" bgcolor="#FFFFFF"><div align="left">
       <div align="left">
         <input name="store_shopowner_name" id="store_shopowner_name" class="dfinput" value="${storeInfo.store_shopowner_name }" onblur="check()"/>
         <label id="tipStore_shopowner_name"></label>
       </div>
     </div></td>
     </tr>
     <tr>
     <td width="10%" height="38" align="center" bgcolor="#F0F5F7"><div>渠道编码：</div></td>
     <td height="38" bgcolor="#FFFFFF"><div align="left">
       <div align="left">
         <input name="channel_code" id="channel_code" class="dfinput" value="${storeInfo.channel_code }" onblur="check()" readonly/>
         <label id="tipChannel_code"><font color="red">门店渠道编码不支持修改</font></label>
       </div>
     </div></td>
     </tr>
     <tr>
     <td width="10%" height="38" align="center" bgcolor="#F0F5F7"><div>门店归属：</div></td>
     <td height="38" bgcolor="#FFFFFF"><div align="left">
         <select id="vendor_id" name="vendor_id" style="opacity:1">
         <c:forEach items="${vendorList }" var="v">
         	<option value='${v.id}' <c:if test="${storeInfo.vendor_id == v.id}">selected="selected"</c:if> >${v.vendor_name }</option>
         </c:forEach>
         </select>
     </div></td>
     </tr>
     ...
     <tr>
     <td width="10%" height="38" align="center" bgcolor="#F0F5F7"><div>门店类型：</div></td>
     <td height="38"><div align="left">
         <select id="type" name="type" style="opacity:1">
         <option value='0' <c:if test="${storeInfo.type == 0}">selected="selected"</c:if>>直营</option>
         <option value='1' <c:if test="${storeInfo.type == 1}">selected="selected"</c:if>>现金/（社会门店）</option>
         </select>
     </div></td>
     </tr>
...
<script>
	...
	$("#store_address").blur(function(){
		var store_address = $("#store_address").val();
		 $.post("${pageContext.request.contextPath}/background/Stroe/checkAddress.html",{"store_address":store_address},function(result){
	...
	function checkHasVal(e){
		 $.post("${pageContext.request.contextPath}/background/Stroe/findPhone.html",{"store_shopowner_phone":e},function(result){
				if(result.state != "ok" && result.id != "${storeInfo.id }"){
