...
<body>
 ...
 <div class="toolbar1"></div>
 <form id="addForm" action="${pageContext.servletContext.contextPath }/background/Express/modifyCourier.html" method="post">
 <table border="0" cellpadding="0" cellspacing="0" bgcolor="#66CCFF"  class="tablelist_left">
   ...
   <tr>
     ...
     <td height="38" bgcolor="#FFFFFF"><div align="left">
       <input name="real_name" id="real_name"  value="${courierInfo.real_name }" class="dfinput"/>
     </div></td>
     </tr>
   <tr>
     ...
     <td height="38" bgcolor="#FFFFFF"><div align="left">
       <div align="left">
         <input name="accountName" id="accountName" value="${courierInfo.accountName }"  class="dfinput" readonly="readonly"/>
     ...
     <td height="38" bgcolor="#FFFFFF"><div align="left">
         ...
         <c:forEach items="${company }" var="v">
         	<option value='${v.id }' <c:if test="${courierInfo.company == v.id}">selected="selected"</c:if> >${v.company_name }</option>
         </c:forEach>
         </select>
     </div></td>
     </tr>
