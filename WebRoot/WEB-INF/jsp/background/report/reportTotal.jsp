...
<div id="usual1" class="usual">
    ...
    <div class="line">
        <div style="font-size: 12px; width: 100%; text-align: right; margin-bottom: 10px;">
            <form id="myform" action="${pageContext.request.contextPath }/background/report/getReportTotal.html"
                  method="post">
                请选择起始日期:
                <input type="text" class="mydate"
                       style="border: 1px solid #000;height: 29px;width: 75px; border-radius:5px; padding-left: 3px; margin-right: 3px;"
                       type="text" id="startTime" name="startTime" value="${startTime }"/>
                请选择结束日期:
                <input type="text" class="mydate"
                       style="border: 1px solid #000;height: 29px;width: 75px; border-radius:5px; padding-left: 3px; margin-right: 3px;"
