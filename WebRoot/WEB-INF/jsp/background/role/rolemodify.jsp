...
<body>
 ...
 <div class="toolbar1"></div>
 <form id="editForm" action="${pageContext.servletContext.contextPath }/background/role/update.html" method="post">
 <table border="0" cellpadding="0" cellspacing="0" bgcolor="#66CCFF"  class="tablelist_left">
   <tr>
     <td width="10%" height="38" align="center" bgcolor="#F0F5F7"><div>角色名称：</div></td>
   ...
   <tr>
     <td width="10%" height="38" align="center" bgcolor="#F0F5F7"><div>角色KEY：</div></td>
     <td height="38" bgcolor="#FFFFFF"><div align="left">
       <div align="left">
   ...
   <tr>
     ...
     <td height="38" bgcolor="#FFFFFF"><div align="left">
       <input name="enable" type="radio" value="2" <c:if test="${role.enable==2}">checked</c:if>/>禁用 
       <input name="enable" type="radio" value="1" <c:if test="${role.enable==1}">checked</c:if>/>启用 
     </div></td>
     </tr>
     <tr>
