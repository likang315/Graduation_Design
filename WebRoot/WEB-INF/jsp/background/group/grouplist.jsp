...
function showrole(id){
	 var url = "${pageContext.servletContext.contextPath }/background/group/permissioRole.html?groupId="+id;
	 var h_sp1 = 400;
	 var w_sp1 = 350;
...
<body>
    ...
    <div class="toolbar1">
    	<ul class="toolbar">
    	  <a href="javascript:addUser()"><li class="click">
     <span>
     <img src="${pageContext.request.contextPath}/images/t01.png" />
     </span>新增组织机构</li></a>
       <%--  <li class="click"><span><a href="wodekehu_02.html"><img src="${pageContext.servletContext.contextPath }/images/t01.png" /></a></span><a href="javascript:addUser();">新增组织机构</a></li> --%>
        <%--  <li class="click"><span><img src="${pageContext.servletContext.contextPath }/images/t01.png" /></span>分配角色</li>
        <li class="click"><span><img src="${pageContext.servletContext.contextPath }/images/t02.png" /></span>辑辑</li> --%>
        <a href="javascript:deleteGroup(1)">
        <li><span><img src="${pageContext.servletContext.contextPath }/images/t03.png" /></span>删除</li>
        </a>
    	</ul>
    </div>
    <div class="itab_nav">
    ...
    <form id="fenye" name="fenye" action="${pageContext.servletContext.contextPath }/background/group/list.html" method="post">
    <table class="tablelist">
        ...
        <td>
        	<a href="javascript:void(0);" onclick="modifyUser('${key.id}')">编辑</a>
        	&nbsp;&nbsp;&nbsp;
        	<a href="javascript:void(0);" onclick="showrole('${key.id}')">分配资源</a>
		</td>
        </tr> 
        </c:forEach>
        </tbody>
