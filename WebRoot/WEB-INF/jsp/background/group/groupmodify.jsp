...
<body>
    ...
    <div class="itab_nav">
  	<ul> 
    <li><a href="#tab1" class="selected">修改组织架构</a></li>
  	</ul>
    </div>
    <div class="line">
 ...
 <div class="toolbar1"></div>
 <form id="editForm" action="${pageContext.servletContext.contextPath }/background/group/edit.html" method="post">
 <table border="0" cellpadding="0" cellspacing="0" bgcolor="#66CCFF"  class="tablelist_left">
   <tr>
     <td width="10%" height="38" align="center" bgcolor="#F0F5F7"><div>组织机构名：</div></td>
     <td height="38" bgcolor="#FFFFFF"><div align="left">
       <input name="name" id="name" class="dfinput" value="${group.name }"/>
     </div></td>
     </tr>
   <tr>
     <td width="10%" height="38" align="center" bgcolor="#F0F5F7"><div>父节点：</div></td>
     <td height="38" bgcolor="#FFFFFF"><div align="left">
       <div align="left">
         <input name="parentId" id="parentId" class="easyui-combotree dfinput" value="${group.parentId }"
