...
<div class="sidebar-left">
    <div class="yctop">
        <div class="yclogo"><img src="${pageContext.request.contextPath}/images/appLoginLogo.png" width="100%"/></div>
        <div class="xingming">
            <div>账户：<label id="userPhone"></label></div>
            <div>所属：<label id="userCity"></label></div>
            <div>账户类型：<label id="userType"></label></div>
        </div>
        <div class="tuichudtb"><img src="${pageContext.request.contextPath}/images/accessdenied.png" width="100%"/>
        </div>
    </div>
