...
<head>
	...
	*{ margin:0; padding:0;}
	body{ font-size:12px;}
	.maxDiv td{ text-align:center; border:1px solid #CCC;}
	
	.maxDiv{border-bottom: 1px solid #ccc;}
	
	.leftMaxDiv{ width:50%; float:left;}
	
	.leftTopDiv{ width:100%; font-weight:bold;}
	.leftTopTable{ width:100%; height:60px; background:#8ca9cf; text-shadow:1px 1px 1px #e8ebee;}
	.leftTopTable tr td:first-child{ width:40%;word-wrap:break-word;}
	.leftTopTable tr td:nth-child(2){ width:60%;}
	
	.leftDiv{width:100%;overflow-y:hidden; }
	.leftTable{width:100%;table-layout:fixed;}
	.leftTable tr td:first-child{ width:40%;word-wrap:break-word;}
	.leftTable tr td:nth-child(2){ width:60%;}
	
	.rightMaxDiv{ width:50%; float:left;}
	
	.rightTopDiv{ width:100%;overflow-x:hidden; font-weight:bold; background:#8ca9cf;text-shadow:1px 1px 1px #e8ebee;}
	.rightTopTable{ height:60px;min-width:600px;}
	
	
	.rightDiv{ width:100%;overflow:auto; }
	.rightTable{min-width:600px;}
	.rightTopTable td{ }
	.rightTable  td{ }
	</style>
</head>
...
<div style="">
	<div style="margin:10px">
        <div style="text-align:center;">
        	<form id="myform" action="${pageContext.request.contextPath}/app/fillingSingle/getMarketingOrderTotal.html" method="post">
        		<table width="100%" border="0" class="mytable">
        			<tr>
        				<td><label>开始时间：</label></td>
        				<td><input type="date" class="mydate" id="startTime" name="startTime" value="${startTime}" /></td>
        			</tr>
        			<tr>
        			...
        			<tr>
        				<td colspan="2"><button type="button" id="timeSearch" class="btn btn-warning" style="width: 35%;">确认</button></td>
        			</tr>
        		</table>
