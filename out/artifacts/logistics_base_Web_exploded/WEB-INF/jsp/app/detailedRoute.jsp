	...
	<head>
       ...
       <script type="text/javascript" src="http://api.map.baidu.com/library/SearchInfoWindow/1.5/src/SearchInfoWindow_min.js"></script>
		<style type="text/css">  
		    ...
		    .d { position:fixed; right:220px; bottom:60px;}
			.maskyanzhengma{
									width: 130px;
    								height: 35px;
    								background: #000;
    								opacity:0;
    								float: right;
    								position: relative;  margin-top: -35px; z-index: 12;display:none;
    								}
			</style>
	</head>
	<body class="bjs-gary">
		...
		<div class="a">
		 ...
		 <!-- <div class="d">
		    <input type="button" id="caiji" value="采集门店经纬度" class="btn btn-success"/>
				...
				<div style=" position: fixed; width: 80%; height: 200px; top:150px;left:10%; background: #fff; z-index: 89999;display:none " id="motaikuang">
					<div style="padding:15px;">
						...
						<div class="form-group">
						    <div class="input-group" >
						        ...
						        <span class="input-group-btn">
						        	<input onclick="acquireCode()" type="button" class="btn btn-info" id="huoquyanzhengma" value="获取验证码"/>
						        </span>
						    </div>
						...
						<!-- <div class="input-group">
	                         ...
	                         <div class="maskyanzhengma">
	                             <input onclick="acquireCode()" type="button" class="btn btn-info" id="huoquyanzhengma" value="获取验证码"/>
	                          </div>
	                          </div>
	                     </div> -->
	                     <div class="show-content" style=" height:20px; color: red;font-size:12px;text-align: center; margin-bottom: 5px"></div>
				...
				<div style=" position: fixed; width: 100%; height: 100%; top:0; left:0; background: #000; z-index: 89999;opacity:0.5; display:none " id="mengban1">
				</div>
				<div style=" position: fixed; width: 80%; height: 150px; top:150px;left:10%; background: #fff; z-index: 89999;display:none " id="motaikuang1">
...
function confirmreceipt(){
	...
	API.ajax("/app/code/testCode2",{"tellPhone":phone,"code":yanzhengma}).success(function(data){
		API.ajax("/app/coordinate/updateOrder",{"id":logistics,"signPhone":phone,"signPeople":signPeople,"recipientTime":recipientTime}).success(function(datas){
		    	         if(datas.state =="ok" ){
		    	        	 if(store_longitude==""||store_latitude==""||store_longitude==0||store_latitude==0){
		 						var	data={"id":logistics,"store_longitude":store_longitudeA,"store_latitude":store_latitudeA,"channel_code":channel_code};
