...
<body class="bjs-gary">
	<div class="container">
 	...
 	<!-- 蒙版 -->
	<div id="bigblack2" style="z-index:9999;width:100%;background:#000;height:100%;position: fixed;top:0px;left:0px;opacity:0.7;display: none;"></div>
	<div id="yesOrNo" style="position:fixed; width:100%; top:150px; z-index: 9999; display: none;">
		...
		<div class="tableDivFillIn" style="height: auto;">
			<form id="form" action="${pageContext.servletContext.contextPath }/app/storeSupplies/addmaterial.html" method="post">
				...
				<table border="1" bordercolor="#ccc" width="100%">
					...
					<tr>
						<td>物品数量:</td>
						<td><input type="number" id="materialNumber" style="width:30%; height:27px; border-radius:3px; border:1px solid #CCC;"/>个</td>
				    </tr>
				</table>
				...
				<div class="addToDiv">
					<input type="button" id="addMaterial" value="添加" class="btn btn-success btn-xs" style="width:100px; margin-top:5px;">
		        </div>
			</form>
		</div>
		...
		<div class="tableDivFillIn" style="height: auto;">
			<table border="1" bordercolor="#ccc" width="100%">
				<tr>
					<td>
						<textarea id="demand" style="width: 100%; height: 100px; resize:none;" placeholder="在这里阐述您的需求"></textarea>
					</td>
				</tr>
			</table>
			<div class="addToDiv">
				<input type="button" id="mysubmit" value="提交" class="btn btn-success btn-xs" style="width:100px; margin-top:5px;">
			</div>
		</div>
	</div>
