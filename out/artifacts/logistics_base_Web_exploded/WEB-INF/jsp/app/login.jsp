	    ...
	    <div class="container ">
	        ...
	        <div class="login_page text-center">
	            ...
	            <div>
	               ...
	               <div class="form-group">
	                    <p class="rember_psw"><a class="pull-right" href="${pageContext.request.contextPath }/app/user/forgetPassword.html">忘记密码</a><!--  <a href="register.html" class="pull-left">账号注册</a> --></p>
	                </div>
