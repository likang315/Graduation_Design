...
<div class="container ">
    <div class="p15"><img src="${pageContext.request.contextPath}/images/china_mobile.png" class="w200"
        ...
        <div>
            <form id="loginForm" action="${pageContext.request.contextPath}/app/login/checkLogin.html" method="post">
                <div class="form-group">
                    <input type="name" class="form-control" id="exampleInputEmail1" name="accountName"
            ...
            <div class="form-group">
                <p class="rember_psw"><a class="pull-right"
                                         href="${pageContext.request.contextPath }/app/user/forgetPassword.html">忘记密码</a>
                </p>
            </div>
