...
<style>
.container{ padding:0;}
.saefas{width:100%; height:50px; background:#FFF; text-align:center;font-size:20px;}
b{ font-size:35px; color:#F00;}
.casd{ width:100%; height:250px; margin:15px 0;}
...
//开始时间和结束时间验证
	...
	/* 	$("#chakan").click(function(){
			location.href="${pageContext.request.contextPath}/app/storeSupplies/StoreAllTotal.html?accountName="+user.accountName+"&&state=0";
		}) */
