...
<body>
    ...
    <div class="toolbar1">
   <ul class="toolbar">
   <a href="javascript:addRole();"><li class="click">
     <span>
    ...
    <form id="fenye" name="fenye" action="${pageContext.servletContext.contextPath }/background/role/query.html" method="post">
  	<div id="tab2" class="tabson">
        ...
        <c:forEach var="role" items="${pageView.records}">
	        ...
	        <td>
	           <a href="javascript:void(0);" onclick="permissio('${role.id}','${role.groupId}')">分配权限</a>&nbsp;&nbsp;
	           <a href="javascript:void(0);" onclick="modifyRole('${role.id}')">编辑</a>
	        </td>
	        </tr>
        </c:forEach>
        </tbody>
