...
.fancyTable td,.fancyTable th{border: 1px solid #ccc;}
 </style>
<!-- 	<script type="text/javascript">
 $(document).ready(function(){
	$("#addForm").validate({
		...
		messages:{
			material:"请输入物资类别",
			materialContent:"请输入物资名称",
			materialNumber:"请输入物资数量",
			consignee:"请输入收货人姓名",
			phone:"请输入收货人电话",
			courierPhone:"请输入快递员电话",
			courierName:"请输入快递员姓名"
		}
	});
}); 
</script> -->
...
<body>
    ...
    <div class="line">
    	<div id="tab2" class="tabson">
			 <div class="toolbar1"></div>
					<form id="addForm" action="${pageContext.servletContext.contextPath }/background/order/updateLogistics.html" method="post" enctype="multipart/form-data">   
					 ...
					 <table border="0" cellpadding="0" cellspacing="0" bgcolor="#66CCFF"  class="tablelist_left">
					   <tr>
					     <td width="10%" height="38" align="center" bgcolor="#F0F5F7"><div>订单号：</div></td>
					   ...
					   <tr>
					     <td width="10%" height="40" align="center" bgcolor="#F0F5F7"><div>物资名称及数量：</div></td>
					      <td height="38" bgcolor="#FFFFFF"><div align="left">
					     ...
					     <%-- <tr>
						     <td width="10%" height="38" align="center" bgcolor="#F0F5F7"><div>物资数量：</div></td>
						     <td height="38" bgcolor="#FFFFFF">
							     <div align="left">
							       <input  name="materialNumber" id="materialNumber" class="dfinput"  value="${logisticslist.materialNumber}"/>
							     </div>
						     </td>
					     </tr> --%>
						   ...
						   <tr>
						     <td width="10%" height="38" align="center" bgcolor="#F0F5F7"><div>收货人：</div></td>
						     <td height="38" bgcolor="#FFFFFF">
							     <div align="left">
							       <div align="left">
					     ...
					     <tr>
						     <td width="10%" height="38" align="center" bgcolor="#F0F5F7"><div>收货人电话：</div></td>
						     <td height="38" bgcolor="#FFFFFF">
							     <div align="left">
							       <input name="phone" id="phone" class="dfinput" value="${logisticslist.phone}" onblur="checkForm()"/>
					     ...
					     <tr>
						     ...
						     <td height="38" bgcolor="#FFFFFF">
							     <div align="left">
							       <input name="courierName" id="courierName" class="dfinput" value="${logisticslist.courierName}"/>
							     </div>
						     </td>
					     </tr>
					     <tr>
						     ...
						     <td height="38" bgcolor="#FFFFFF">
							     <div align="left">
							       <input name="courierPhone" id="courierPhone" class="dfinput" value="${logisticslist.courierPhone}" onblur="checkForm()"/>
							       <label id="tipCourierPhone"></label>
							     </div>
						     </td>
					     </tr>
					     <tr>
						     <td width="10%" height="38" align="center" bgcolor="#F0F5F7"><div>收货具体地址：</div></td>
						     <td height="38" bgcolor="#FFFFFF">
							     <div align="left">
						   ...
						   <tr>
						     ...
						     <td height="54" bgcolor="#FFFFFF"><input type="button" id="subForm" value="　修　改　" class="btn btn-success" />
						       <input onclick="javascript:window.location.href='javascript:history.go(-1)'" id="backBt" type="button" value="　返　回　"  class="btn btn-success"/></td>
						   </tr>
						 </table>
					 </form>
		            ...
		            <table class="fancyTable" id="myTable02" width="100%" cellpadding="0" cellspacing="0">
		                ...
		                <tbody id="mytbody">
		                	...
		                	<tr id="${c.materialId }">
		                		<td>${c.materialC} </td>
		                		<td>${c.materialN}</td>
		                		<td><a onclick="javascript:mydelete('${c.materialId}','${c.materialC}','${c.materialN}')">删除</a></td>
		                    </tr>
		                	</c:forEach>
				    ...
				    <div class="labelInformation">物流信息</div>
				  	<div class="tableDivFillIn">
					        ...
					        <table border="1" bordercolor="#ccc" width="100%">
					            ...
					            <tr>
					            	<td>物品数量:</td>
					                <td><input type="number" min="0" id="materialNumber" style="width:30%; height:27px; border-radius:3px; border:1px solid #CCC; padding-left: 5px;"/></td>
					                <label id="tip"></label>
					            </tr>
					        </table>
					        ...
					        <div class="addToDiv">
					        	<input type="button" id="ok" value="添加" class="btn btn-success btn-xs" style="width:100px; margin-top:5px;"/>
					        </div>
	...
	function checkForm(){
		...
		if(!myreg.test(courierPhone)){
			...
			//验证快递员信息是否在库
			$.ajax({ url: "checkcourierPhone.html",
					type: "POST",
				  	dataType: "JSON",
