...
<div class="loginbody">
    ...
    <div class="loginbox">
        <form id="loginForm" name="loginForm" method="post"
            ...
            <ul>
                <li><input type="text" class="loginuser" id="username" placeholder="用户名" name="username" tabindex="1"/>
                </li>
                <li><input type="password" class="loginpwd" id="password" placeholder="密码" name="password"
                           tabindex="2"/></li>
