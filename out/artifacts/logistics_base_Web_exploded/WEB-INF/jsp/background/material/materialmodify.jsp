...
<body>
 ...
 <div class="toolbar1"></div>
 <form id="addForm" action="${pageContext.servletContext.contextPath }/background/Material/modify.html" method="post">
   ...
   <tr>
    <input type="hidden" name="id" id="id"  value="${materialInfo.id }"/>
     ...
     <td height="38" bgcolor="#FFFFFF"><div align="left">
       <input name="material_name" id="material_name" class="dfinput" value="${materialInfo.material_name }" onblur="check()"/>
     ...
     <td height="38" bgcolor="#FFFFFF"><div align="left">
       <input name="code" id="code" class="dfinput" value="${materialInfo.code }" onblur="check()" readonly="readonly"/>
       <label id="tipCode"><font color="red">物资编码不支持修改</font></label>
     </div></td>
     </tr>
