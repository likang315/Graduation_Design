							...
							<tbody>
								<c:forEach var="material" items="${page.items}">
									<tr>
										...
										<td>
											<a href="javascript:void(0);" onclick="permissio('${material.id}')">修改</a>&nbsp;&nbsp;
										</td> 
									</tr>
								</c:forEach>
							</tbody>
...
function permissio(id){
	window.location.href = "${pageContext.servletContext.contextPath }/background/Material/permissio.html?id="+id;
}
