...
<body>
 ...
 <div class="toolbar1"></div>
 <form id="addForm" action="${pageContext.servletContext.contextPath }/background/account/modifyPass.html" method="post">
 <table border="0" cellpadding="0" cellspacing="0" bgcolor="#66CCFF"  class="tablelist_left">
   
     <tr>
     <td width="10%" height="38" align="center" bgcolor="#F0F5F7"><div>新密码：</div></td>
     <td height="38" bgcolor="#FFFFFF"><div align="left">
      ...
      <tr>
     <td width="10%" height="38" align="center" bgcolor="#F0F5F7"><div>再次输入密码：</div></td>
     <td height="38" bgcolor="#FFFFFF"><div align="left">
       <div align="left">
