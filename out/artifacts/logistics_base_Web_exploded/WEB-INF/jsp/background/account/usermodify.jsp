...
<body>
 ...
 <div class="toolbar1"></div>
 <form id="editForm" action="${pageContext.servletContext.contextPath }/background/account/update.html" method="post">
 <table border="0" cellpadding="0" cellspacing="0" bgcolor="#66CCFF"  class="tablelist_left">
   <tr>
     ...
     <td height="38" bgcolor="#FFFFFF"><div align="left">
       <input name="accountName" id="accountName" class="dfinput" value="${account.accountName}"/>
     ...
     <tr>
     <td width="10%" height="38" align="center" bgcolor="#F0F5F7"><div>所属组织机构：</div></td>
     <td height="38" bgcolor="#FFFFFF"><div align="left">
       <div align="left">
        <%--  <input name="groupId" class="dfinput" value="${account.groupId}"/> --%>
         
           <input name="groupId" class="easyui-combotree dfinput" value="${account.groupId}"
   ...
   <tr>
     ...
     <td height="38" bgcolor="#FFFFFF"><div align="left">
       <input name="state" type="radio" value="2" <c:if test="${account.state==2}">checked</c:if>/>禁用 
       <input name="state" type="radio" value="1" <c:if test="${account.state==1}">checked</c:if>/>启用 
     </div></td>
     </tr>
     <tr>
