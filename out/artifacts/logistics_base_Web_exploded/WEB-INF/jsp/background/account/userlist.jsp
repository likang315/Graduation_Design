...
<div style="z-index:9999;position:fixed;top:100px; width:100%; display:none;" id="modalnr">
    ...
    <form id="fenye" name="fenye" action="${pageContext.servletContext.contextPath }/background/account/query.html" method="post">
    <table class="tablelist">
        ...
        <td>
        	...
        	&nbsp;&nbsp;&nbsp;
        	<%-- <a href="javascript:void(0);" onclick="showrole('${key.groupId}',${key.id })">分配角色</a>
        	&nbsp;&nbsp;&nbsp; --%>
        	<a href="javascript:void(0);" onclick="modifyPassword(${key.id })">修改密码</a>
		</td>
        </tr> 
        </c:forEach>
        </tbody>
