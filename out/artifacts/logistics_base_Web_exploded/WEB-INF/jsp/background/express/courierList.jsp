                    ...
                    <table class="tablelist">
                        ...
                        <c:forEach var="courier" items="${courierList}">
                            <tr>
                                ...
                                <td>
                                    <a href="javascript:void(0);" onclick="permission('${courier.id}')" style="color: blue; margin-left: 35%">修改</a>
                                </td>
                            </tr>
                        </c:forEach>
                        </tbody>
...
<script>
    ...
    function permission(id) {
        window.location.href = "${pageContext.servletContext.contextPath }/background/Express/permissionCourier.html?id=" + id;
    }
