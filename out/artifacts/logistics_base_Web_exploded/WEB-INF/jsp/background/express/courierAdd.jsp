...
<div class="formbody">
    <div id="usual1" class="usual">
        <div class="itab_nav">
            <ul>
                <li><a href="#tab1" id="sigStore" class="selected">快递员信息维护</a></li>
            </ul>
        </div>
        <div class="line">
            <div id="tab2" class="tabson">
                ...
                <div class="toolbar1"></div>
                <form id="addForm"
                      action="${pageContext.servletContext.contextPath }/background/Express/addCourier.html"
        ...
        <form action="${pageContext.servletContext.contextPath }/background/Express/addCourier.html" method="post"
