...
<body>
    ...
    <div class="itab_nav">
  	<ul> 
    <li><a href="#tab1" class="selected">新增组织架构</a></li>
  	</ul>
    </div>
    <div class="line">
 ...
 <div class="toolbar1"></div>
 <form action="${pageContext.servletContext.contextPath }/background/group/add.html" method="post" id="addForm">
