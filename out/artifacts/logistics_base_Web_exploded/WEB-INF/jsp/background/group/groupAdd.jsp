...
<div class="formbody">
    <div id="usual1" class="usual">
        <div class="itab_nav">
            <ul>
                <li><a href="#tab1" class="selected">新增组织机构</a></li>
            </ul>
        </div>
        <div class="line">
            <div id="tab2" class="tabson">
                ...
                <div class="toolbar1"></div>
                <form action="${pageContext.servletContext.contextPath }/background/group/add.html" method="post"
                      id="addForm">
