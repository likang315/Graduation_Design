...
<body>
    ...
    <div class="toolbar1">
   <ul class="toolbar">
   <a href="javascript:addResource()"><li class="click">
     <span>
     <img src="${pageContext.request.contextPath}/images/t01.png" />
     </span>新增</li></a>
     <a href="javascript:deleteresource(2);"><li class="click">
     <span>
    ...
    <div class="line">
  	<div id="tab2" class="tabson">
        ...
        <c:forEach items="${resourceList}" var="treeo">
	        ...
	        <td><a href="${pageContext.request.contextPath}/background/resources/editUI.html?resourcesId=${treeo.id}"">${treeo.name}</a></td>
	        <td>${treeo.type}</td>
	        <td>${treeo.resKey} </td>
	        <td>${treeo.resUrl} </td>
	        ...
	        <c:choose>
	        	<c:when test="${!empty treeo.children}">
	        		...
	        		<tr>
				        ...
				        <td><a href="${pageContext.request.contextPath}/background/resources/editUI.html?resourcesId=${treech.id}">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				        ${treech.name}</a></td>
				        <td>${treech.type}</td>
				        <td>${treech.resKey} </td>
				        <td>${treech.resUrl} </td>
			        	...
			        	<c:when test="${!empty treech.children}">
			        		<c:forEach items="${treech.children}" var="treech1">
				        		<tr>
							        ...
							        <td><a href="${pageContext.request.contextPath}/background/resources/editUI.html?resourcesId=${treech1.id}"">
							        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							        ${treech1.name}</a></td>
							        <td>${treech1.type}</td>
