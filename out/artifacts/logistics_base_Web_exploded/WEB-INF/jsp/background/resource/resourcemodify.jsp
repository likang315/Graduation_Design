...
<body>
 ...
 <div class="toolbar1"></div>
 <form id="editForm" action="${pageContext.servletContext.contextPath }/background/resources/edit.html" method="post">
 <table border="0" cellpadding="0" cellspacing="0" bgcolor="#66CCFF"  class="tablelist_left">
   ...
   <tr>
     ...
     <td height="38" bgcolor="#FFFFFF"><div align="left">
       <div align="left">
         <input type="radio" value="0" name="type" <c:if test="${resources.type==0}">checked</c:if>/>目录　　
         <input type="radio" value="1" name="type" <c:if test="${resources.type==1}">checked</c:if>/>菜单　　
         <input type="radio" value="2" name="type" <c:if test="${resources.type==2}">checked</c:if>/>按扭 
       </div>
     </div></td>
     </tr>
   <tr>
