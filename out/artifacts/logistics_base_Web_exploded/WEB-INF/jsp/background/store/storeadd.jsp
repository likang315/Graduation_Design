...
<body>
 ...
 <div class="toolbar1"></div>
 <form id="addForm" action="${pageContext.servletContext.contextPath }/background/Stroe/add.html" method="post" enctype="multipart/form-data">
 <table border="0" cellpadding="0" cellspacing="0" bgcolor="#66CCFF"  class="tablelist_left">
   ...
   <tr>
    ...
    <!-- <tr>
     ...
     <td height="38" bgcolor="#FFFFFF"><div align="left">
       <div align="left">
         <input name="store_longitude" id="store_longitude" class="dfinput" onblur="check()"/>
    ...
    <tr>
     ...
     <td height="38" bgcolor="#FFFFFF"><div align="left">
       <div align="left">
         <input name="store_latitude" id="store_latitude" class="dfinput" onblur="check()" />
     ...
     <td height="38" bgcolor="#FFFFFF" style="margin-left:20px;"><div align="left">
       <div align="left">
      ...
      <tr>
     <td width="10%" height="38" align="center" bgcolor="#F0F5F7"><div>店长电话：</div></td>
     <td height="38" bgcolor="#FFFFFF"><div align="left">
       <div align="left">
         <input name="store_shopowner_phone" id="store_shopowner_phone" class="dfinput" onblur="check()"/>
     ...
     <td height="38" bgcolor="#FFFFFF"><div align="left">
       <div align="left">
         <input name="store_shopowner_name" id="store_shopowner_name" class="dfinput" onblur="check()"/>
   ...
   <tr>
    ...
    <form action="${pageContext.servletContext.contextPath }/background/Stroe/add.html" method="post" enctype="multipart/form-data" id="addForm2">
   ...
   <tr>
     ...
     <td height="38" bgcolor="#FFFFFF"><div align="left">
       <div align="left">
         <input type="file" name="file" id="fileExcel" class="dfinput" onchange="checkFile()"/>
    ...
    <tr>
     ...
     <td height="54" bgcolor="#FFFFFF"><input type="button" id="sub2" value="确认维护" />
       <input onclick="javascript:window.location.href='javascript:history.go(-1)'" id="backBt1" type="button" value="　返　回　" />
       	<input type="button" value="下载模板" onclick="javascript:window.location.href=encodeURI(encodeURI('${pageContext.servletContext.contextPath }/background/report/downDomeFile.html?fileName=门店信息导入模板.xlsx'))"/>
       </td>
       <%-- <td height="54" bgcolor="#FFFFFF">
       	<input type="button" value="下载模板" onclick="javascript:window.location.href=encodeURI(encodeURI('${pageContext.servletContext.contextPath }/background/report/downDomeFile.html?fileName=门店信息导入模板.xlsx'))"/></td> --%>
   </tr>
     </table>
    </div>
    </form>
